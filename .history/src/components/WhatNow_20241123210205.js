    ...
    return (
        <div style={{ width: '80%', margin: '0 auto', paddingTop: '50px' }}>
            <Slider {...settings}>
                ...
                <div className="card">
                    <iframe
                        src="https://www.morganstanley.com/articles/digital-footprint-protection-strategies"
                ...
                <div className="card">
                    <iframe
                        src="https://www.keepersecurity.com/blog/2023/01/30/tips-to-clean-up-your-digital-footprint/"
