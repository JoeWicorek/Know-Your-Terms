...
import SocialMediaInfoChart from './SocialMediaInfoChart'; // Import the SocialMediaInfoChart component
...
const Home = () => {
    return (
        <div className="home-container">
            ...
            {/* Add the SocialMediaInfoChart component with only images */}
            <div className="sidebar">
                <h3>Search Social Media Platforms</h3>
