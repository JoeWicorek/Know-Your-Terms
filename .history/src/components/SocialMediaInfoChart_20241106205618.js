    ...
    return (
        <div className="chart-container">
            <div className="grade-scale">
                <div className="grade-label" style={{ left: gradePositions["A+"] }}>A+</div>
                <div className="grade-label" style={{ left: gradePositions["B-"] }}>B-</div>
                <div className="grade-label" style={{ left: gradePositions["C+"] }}>C+</div>
                <div className="grade-label" style={{ left: gradePositions["D-"] }}>D-</div>
                <div className="grade-label" style={{ left: gradePositions["E+"] }}>E+</div>
                <div className="grade-label" style={{ left: gradePositions["F-"] }}>F-</div>
