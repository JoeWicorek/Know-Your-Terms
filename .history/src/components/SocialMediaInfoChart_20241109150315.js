...
const platformData = [
    { platform: "Facebook", imageUrl: "/img/facebook-logo.png", grade: "A+" },
    { platform: "Google", imageUrl: "/img/google-logo.png", grade: "B-" },
    { platform: "Twitter", imageUrl: "/img/twitter-logo.png", grade: "C+" },
    { platform: "Instagram", imageUrl: "/img/instagram-logo.png", grade: "D-" },
    { platform: "TikTok", imageUrl: "/img/tiktok-logo.png", grade: "E+" }
];
